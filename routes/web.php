...
// 3. Owner + Manager - จัดการข้อมูลและรายจ่าย
...
// 4. Owner + Manager + Cashier - การจัดการออร์เดอร์และชำระเงิน
Route::middleware(['role:owner,manager,cashier'])->group(function () {
    ...
    Route::post('/admin/rider/Riderconfirm_pay', [Rider::class, 'Riderconfirm_pay'])->name('Riderconfirm_pay');
    Route::post('/admin/rider/Riderconfirm_is_pay', [Rider::class, 'Riderconfirm_is_pay'])->name('Riderconfirm_is_pay');
...
Route::middleware(['role:owner,manager,cashier,staff'])->group(function () {
    ...
    Route::post('/admin/memberorder/updatestatusMenu', [Memberorder::class, 'updatestatusMenu'])->name('updatestatusMenu');
